...
>
    <div>
        <a href="<?php echo route('home'); ?>" class="block py-navbar-item pl-5" style="display: flex; align-items: center; justify-content: center;"><img src='https://i.postimg.cc/52WcXyWy/logosmall.png' style="height: 25px;"></a>
    </div>
    <!-- Responsive Menu -->
    <div
