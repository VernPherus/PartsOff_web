                        ...
                        <div class="row justify-content-center">
                            <div class="mb-5">
                                ...
                                <div class="profile-pic-container d-flex justify-content-center">
                                    <img src="{{ asset('assets\images\alex.jpg') }}" alt="Profile Picture"
                                        class="profile-img">
                                </div>
                                <!-- Profile Details -->
                            ...
                            <div class="col-12">
                                <div class="list-group">
                                    ...
                                    <a href="{{ url('/shop_Order') }}"
                                        class="list-group-item list-group-item-action">User DataBase</a>
                                    <a href="{{ url('/shop_product') }}"
                                        class="list-group-item list-group-item-action">Seller Database</a>
